...
<img alt="ScreenShot" src="./images/SS_0.png" width="732">  

[warp](https://www.warp.dev) + [Starship](https://starship.rs/ja-JP/) + [lsd](https://github.com/lsd-rs/lsd) にて  
<img alt="ScreenShot" src="./images/SS_1.png" width="748">  
...
最新版 (v1.1.5)
- [フォント](https://github.com/omonomo/Cyroit/releases/download/v1.1.5/Cyroit_v1.1.5.zip)
- [ソースコード](https://github.com/omonomo/Cyroit/archive/refs/tags/v1.1.5.zip)
