# 全角英数や半角カナが判別しやすく、文字間隔調整機能の付いた等幅フォント「Cyroit」
...
最新版 (v1.5.1)
- [フォント](https://github.com/omonomo/Cyroit/releases/download/v1.5.1/Cyroit_v1.5.1.zip)
- [ソースコード](https://github.com/omonomo/Cyroit/archive/refs/tags/v1.5.1.zip)
